...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/aldoSugiarto/CustomRounded.git"
  ...
  spec.author             = { "AldoSugiarto" => "b_aldrino_s@yahoo.com" }
  ...
  spec.source       = { :git => "https://github.com/aldoSugiarto/CustomRounded.git", :tag => "#{spec.version}" }
